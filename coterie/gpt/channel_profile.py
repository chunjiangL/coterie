"""ChannelProfileBuilder — OpenAI variant. Mirrors claude/channel_profile.py."""
...
### Recurring threads
<numbered list, max 5, each ≤12 words>

### Roster
<name — 1 short phrase about what they post, max 5 entries>
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python -m coterie.gpt.channel_profile <channel_id>")
        sys.exit(1)
